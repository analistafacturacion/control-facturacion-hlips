# Script de Migración para Control Facturación
# Migra maindb.sql a PostgreSQL en Render
...
Write-Host "🚀 Script de Migración - Control Facturación" -ForegroundColor Green
...
# Convertir SecureString a texto plano para psql
